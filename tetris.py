...
st.header('PERCUMA LAPOR POLISI?')
st.markdown("![Lambang POLRI](https://static.republika.co.id/uploads/images/inpicture_slide/logo_200625094047-486.jpg)")
st.markdown("Frasa atau tagar **\#PercumaLaporPolisi** saat ini sering muncul dalam berbagai pemberitaan di media massa yang berkaitan dengan kasus yang menyandung internal kepolisian.\n\n Berdasarkan data pencarian kata yang dihimpun Google Trend, ternyata frasa atau tagar ini sudah sering dipakai dalam 5 tahun terakhir, namun kembali *booming* akhir-akhir ini, terutama di media sosial. \n\nFenomena *booming-phrase* tersebut kembali terjadi dikarenakan beberapa kasus internal polisi yang dinilai negatif oleh masyarakat, seperti [Kasus Pembunuhan oleh Ferdy Sambo](https://nasional.kompas.com/read/2022/09/07/11293841/kasus-ferdy-sambo-dan-siasat-kapolri-benahi-polri) dan yang paling terbaru adalah [Kasus Narkoba Teddy Minahasa](https://nasional.kompas.com/read/2022/10/15/15304311/pertaruhan-citra-polri-di-3-kasus-besar-teddy-minahasa-ferdy-sambo-dan)")
...
if(st.checkbox('Lihat Data Google Trend')):
    ...
    st.text('Rate Tren Frasa "#PercumaLaporPolisi" Tahun 2017-2022')
    ...
    st.text('Tren Frasa "#PercumaLaporPolisi" Berdasarkan Provinsi Tahun 2017-2022')

st.markdown('Apakah perspektif dalam bentuk tagar atau frasa yang sedang bergema di masyarakat ini menggambarkan turunnya elektabilitas POLRI dan situasi keamanan di Indonesia? Mari kita sandingkan opini tersebut berdasarkan data yang ada!\n\n\n\n\n\n')
...
def show_desc(prov_input):
    ...
    st.markdown('adalah selang waktu atau interval waktu terjadinya satu tindak kejahatan dengan kejahatan yang lain. Selang waktu kejadian kriminal dinyatakan dalam satuan waktu detik')
